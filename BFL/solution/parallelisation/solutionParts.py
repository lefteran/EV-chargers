...
#
#
#     def connectVehicleToClosestFacilityPrl(self, newLocalPart, localPartsDict, zoneId, parameters, vehicleId,
#                                            facilityToRemove):
...
#             if zoneKey != zoneId:
#                 for facilityKey, _ in localPartsDict[zoneKey].omega.items():
#                     if (parameters.timesDict[vehicleId][facilityKey] < closest) and localPartsDict[zoneKey].is_openPrl(
#                             facilityKey) and (facilityKey != facilityToRemove):
...
#             if (parameters.timesDict[vehicleId][facilityKey] < closest) and newLocalPart.is_openPrl(facilityKey) and (
#                     facilityKey != facilityToRemove):
#                 closest = parameters.timesDict[vehicleId][facilityKey]
#                 closestFacility = facilityKey
...
#             closestFacility = self.connectVehicleToClosestFacilityPrl(newLocalPart, localPartsDict, zoneId, parameters,
