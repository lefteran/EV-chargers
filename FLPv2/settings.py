...
vehicles_per_recharging_node_dict = 'data/recharging_nodes/recharging_nodes_duplicates_' + date_of_trips + '_' + str(fleet_size) + '.json'
...
fleet_travel_times = 'data/travel_times/fleet_travel_times_' + date_of_trips + '_' + str(fleet_size) +  '.json'
traffic_travel_times = 'data/travel_times/traffic_travel_times_' + date_of_trips + '_' + str(fleet_size) +  '.json'
...
existing_stations = 'data/existing_stations/existing_stations.json'
...
traffic_demand = 'data/traffic_demand/traffic_demand.json'
rhos = 'data/rhos/rhos_' + str(alpha_probability) + '_' + str(b_vehicles_in_queue) + '.json'
zoning = 'data/Chicago/chicago_zoning.geojson'
candidates_zoning = 'data/Chicago/' + str(centroids) + '_candidate_zoning.json'
existing_zoning = 'data/Chicago/existing_zoning.json'
zones = 'data/Chicago/zones.json'
candidates_and_existing = 'data/candidates_and_existing/candidates_and_existing.json'
raw_building_permits = 'data/building_permits/Building_Permits.csv'
building_permits = 'data/building_permits/building_permits.json'
candidate_permits_dict = 'data/building_permits/candidates_permits_dict.json'
