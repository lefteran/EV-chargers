...
percentage_of_vehicles_needing_recharge = 0.001
...
continuous_solution = 'data/' + borough + '/solutions/continuous_solution.json'
integer_solution = 'data/' + borough + '/solutions/integer_solution.json'
optimal_formulation = 'data/' + borough + '/solutions/formulation.json'
ga_solution = 'data/' + borough + '/solutions/ga_solution_' + str(fleet_size) + '_fleet_' + str(centroids) + '_candidates.json'
ga_outputs = 'data/' + borough + '/solutions/ga_outputs_' + str(fleet_size) + '_fleet_' + str(centroids) + '_candidates.json'
ga_initial_population = 'data/' + borough + '/solutions/intial_population_' + date_of_trips + '_' + str(fleet_size) + '.json'
ga_initial_fitness_set = 'data/' + borough + '/solutions/fitness_set_' + date_of_trips + '_' + str(fleet_size) + '.json'
temp = 'data/' + borough + '/solutions/variable_fleet_size/ga_solution_' + str(fleet_size) + '_fleet_' + str(centroids) + '_candidates.json'
